...
<p>This starts with getting a microcontroller devboard to runn in a very deep sleep at near-0 current draw.</p>
...
<p>A good sleep mode seems really important especially when the baseline idle draw is 60 mA. I&#39;m really dissapointed this is so difficult, my expectations were higher. I will need to figure out deep sleep for the calculator project im working on. I will probably have to do register poking, but I expected that would take too much time for this project. Sleep modes can get really complicated for me.</p>
...
<p>I also had to desolder the little SMD power LED. It was really hard. After several minutes I ended up accidentally smashing it beyond recognition with my iron, which appearantly did the trick. </p>
...
<p>Also, after measuring the AC voltage though one of the coils, I realized I also needed a gear ratio to make the motor spin faster.</p>
...
<p>Now the problem was that the sun gear had a D-shaped hole but my shaft was O-shaped. A D shaft would make tolerances so much easier, but filing the shaft down accurately sounded too risky so I brought the sun gear into Onshape and made the its hole into an O and printed a few out to hammer in. My first attempt got the sun gear on, but it cracked. I adjusted the tolerance and it helped. It was really hard to get all the planet gears in.</p>
<img src={crankentimer30}/>
<p>Once assembly was done, I was afraid it wouldnt forward-drive at all, let alone backdrive. I had to print a handle to even see if it would rotate. So I made a stick with a hole in it. It did rotate, which was a relief. Things were looking good.</p>
...
<h3 id="i-ran-the-same-power-tests-as-before-with-no-load-voltage-and-loaded-current-and-it-was-dissapointing-again-">I ran the same power tests as before with no-load voltage and loaded current, and it was dissapointing again:</h3>
...
<p>At this point my LiPo battery had already arrived and I played with it a bit. I was too scared to trust cheap ones from Amazon so I got it from Adafruit. I got a much bigger capacity than I needed to I can re-use this for a future project I have in mind.</p>
<img src={crankentimer12}/>
<p>One big problem with my battery setup was that there was no clean shut-off point when the battery drained. My circuit would just start turning on and off a few times per second. I guess that makes sense: The battery goes below the 3.0 V cutoff point, the load goes away, the voltage increases above the shutoff threshold slightly, it gets loaded, the voltage decreases below the theshold again, etc.</p>
...
<p>I plugged my original gear ratio design in to the battery charger and that also lit up the charging status LED. Maybe my original design was fine actually? To find out, I had to discharge my battery completely again and see if I could add enough juice to it with my crank. </p>
...
<img src={twinbell}/>
<p>If I bought a replacement LiPo, this would just happen again. I doubt LiPo is viable because the nature of my project is such that it sits at &quot;0%&quot; for a long time and occassionally gets charged to &quot;%5&quot;-ish, which is even worse for LiPos than I thought, appearantly.</p>
...
<p>In my EDA of choice, I made a schematic. I picked out real pin header parts and real through-hole passives from the parts library, which felt unecessary, but I wasn&#39;t sure what my other option was besides making a bunch of custom symbols and footprints, which sounds like a lot of work. Then I laid them out on the PCB view. I carefully routed them with wide traces; I knew I would have to cut around all of them with a knife.</p>
...
<p>In my first print, none of my components fit: the holes printed out smaller than I thought. So I printed a new one.</p>
